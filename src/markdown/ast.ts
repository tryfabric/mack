...
export function emphasis(
  ...children: Exclude<PhrasingContent, Image>[]
): Emphasis {
  return {
    type: 'emphasis',
    children: children,
...
export function strong(...children: Exclude<PhrasingContent, Image>[]): Strong {
  return {
    type: 'strong',
    children: children,
  };
...
export function image(url: string, title?: string): Image {
  return {
    type: 'image',
    url: url,
    title: title,
...
export function link(
  url: string,
  ...children: Exclude<StaticPhrasingContent, Image>[]
): Link {
  return {
    type: 'link',
    children: children,
